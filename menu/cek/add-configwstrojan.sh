...
#buat text all link
cat > /home/vps/public_html/configws-trojan-$user.txt<<EOF
${trojanlinkwstls}
${trojanlinkgrpc}
EOF
cd
...
echo -e "URL CONFIG V2RAYNG all trojan-vless-vmess : ${NC}${RED} http://${domain}:89/configws-trojan-$user.txt ${NC}" 
echo -e "===================================================="
echo -e                "AKCELL XRAY TROJAN-GO"
echo -e "===================================================="
